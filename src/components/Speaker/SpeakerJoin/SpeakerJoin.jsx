...
const SpeakerJoin = (props) => {
 ...
 const { speakerName, presentationTitle } = props.mainPage
 return (
  <div className="form-group">
   ...
   <input type="text" className="form-control" id="nameInput1" placeholder="Įveskite prezentacijos pavadinimą" value={presentationTitle} onChange={(e) => { updatePresentationTitle(e.target.value) }} />
   <button type="button" className="btn btn-primary mt-2" disabled={speakerName.length === 0 || presentationTitle === 0} onClick={() => { emit('start', { name: speakerName, title: presentationTitle }) }}>Prisijungti</button>
